namespace TXServer.Library {
    public static class MathUtils {
        ...
        public static long Map(long value, long inMin, long inMax, long outMin, long outMax) => (value - inMin) * (outMax - outMin) / (inMax - inMin) + outMin;
        ...
        public static decimal Map(decimal value, decimal inMin, decimal inMax, decimal outMin, decimal outMax) => (value - inMin) * (outMax - outMin) / (inMax - inMin) + outMin;
    }
}
